...
// что я сделал : просто тупо все скопировал из первого задания
// NPM npm install simplelightbox
// подставил новую html разметку 
// вставил в html  script  и link с библиотеки SimpleLightbox 
// закамментировал  переменную в которой хранился адрес изображения из первой библиотеки, а так же вызов ее функции 
// в документации  библотекке SimpleLightbox скопирвал первый же пример создания эксземпляра.
